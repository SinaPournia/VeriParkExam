...
import com.veriparkexam.Presenters.IMKBFallingPresenter;
...
public class IMKBFalling extends BaseActivity implements IMKBContractAndPresenter.ViewContract,IMKBPresenter.IMKBViewContract {
    @BindView(R.id.PRGS) ProgressBar progressBar;
    @BindView(R.id.recycler_viewIMKBFalling) RecyclerView mRecyclerView;
    @BindView(R.id.SearchView) SearchView searchView;
    private ArrayList<StockandIndex> data ;
    private ArrayList<StockandIndex> feedsList;
    private IMKBAdapter adapter;
    LinearLayoutManager linearLayoutManager;
    IMKBFallingPresenter stockAndIndexPresenterFalling;

    @Override
    public void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_imkbfalling);
        ButterKnife.bind(this);
        mRecyclerView = (RecyclerView) findViewById(R.id.recycler_viewIMKBFalling);
        linearLayoutManager=  new LinearLayoutManager(this);
        searchView = (SearchView) findViewById(R.id.SearchView);
        mRecyclerView.setLayoutManager(linearLayoutManager);
        progressBar= (ProgressBar) findViewById(R.id.PRGS);
        stockAndIndexPresenterFalling= new IMKBFallingPresenter(this,this);
        stockAndIndexPresenterFalling.GetData();
        ...
        searchView.setOnQueryTextListener(new SearchView.OnQueryTextListener() {
            ...
            public boolean onQueryTextChange(String newText) {
                stockAndIndexPresenterFalling.Search( new SearchObject.HigherSearchItem(data,newText.toUpperCase()));
