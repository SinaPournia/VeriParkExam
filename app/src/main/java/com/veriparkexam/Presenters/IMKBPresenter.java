...
public class IMKBPresenter extends IMKBContractAndPresenter implements IMKBContractAndPresenter.HighSearch {

    IMKBViewContract IMKBview;
    public IMKBPresenter(ViewContract view, IMKBViewContract IMKBview) {
        super(view);
    ...
    public void keyIsReady(String Key) {
        new Model(this).startIMKB(Key,"Month");
    }
    ...
    public interface IMKBViewContract extends IMKBContractAndPresenter.ViewContract{
